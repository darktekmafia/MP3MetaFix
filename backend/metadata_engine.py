...
class MetadataModel(BaseModel):
    ...
    composer: Optional[str] = Field(default="", description="Composer")
    genre: Optional[str] = Field(default="", description="Music genre")
    year: Optional[str] = Field(default="", description="Release year or date")
    track_number: Optional[str] = Field(default="", description="Track number")
    total_tracks: Optional[str] = Field(default="", description="Total tracks")
    disc_number: Optional[str] = Field(default="", description="Disc number")
    total_discs: Optional[str] = Field(default="", description="Total discs")
    bpm: Optional[str] = Field(default="", description="Beats per minute")
    comment: Optional[str] = Field(default="", description="User comment")
    lyrics: Optional[str] = Field(default="", description="Unsynchronized lyrics")
    custom_filename: Optional[str] = Field(default=None, description="Requested output filename")
